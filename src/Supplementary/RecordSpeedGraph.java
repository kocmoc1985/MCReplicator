 ...
 */
public class RecordSpeedGraph implements Runnable {
    ...
    public RecordSpeedGraph(String title, String units, Color modul_color, Font title_font) {
        if (modul_color != null) {
        ...
        while (run) {
            synchronized (this) {
                try {
                    ...
                    Logger.getLogger(RecordSpeedGraph.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
